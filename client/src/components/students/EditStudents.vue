    ...
    >
      <form @submit.prevent="saveEditUser">
        <div class="flex items-center gap-4 mb-4">
          ...
          <InputText id="name" class="flex-auto" autocomplete="off" v-model="form.fullname" />
        </div>

        <div class="flex items-center gap-4 mb-4">
          <label for="username" class="font-semibold w-24">Username</label>
          <InputText id="username" class="flex-auto" autocomplete="off" v-model="form.username" />
        </div>
        ...
        <div class="flex items-center gap-4 mb-4">
          ...
          <InputText id="course" class="flex-auto" autocomplete="off" v-model="form.course" />
        </div>
